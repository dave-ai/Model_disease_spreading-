...
tic
struct_people = repmat(PersonClassV2(true, false, false, false, false, false, false, false, false, 14, 7), [1,num_popul]);
toc
...
% C3) init case 0
struct_people(1,1) = PersonClassV2(false, false, true, false, false, false, false, false, false, 14, 7);
...
for iTime = 1:num_days
    ...
    for iPeople = 1:num_popul
        ...
        if struct_people(1,iPeople).sick == true && struct_people(1,iPeople).time_from_infection == 1
            struct_people(1,iPeople).sick = false;
            struct_people(1,iPeople).infective = true;
            
            diff_infective_tot = diff_infective_tot + 1;
        end
        
        % the person can infect
        if struct_people(1,iPeople).infective == true 
            if dbg_msg
                    ...
                    if struct_people(1,iPeople).time_from_infection == struct_people(1,iPeople).days_of_transmission(1,iInfection)
                        ...
                        while number_trial < max_number_trial && new_infection == false
                              ...
                              [struct_people(1,contact_with), tot_infected, num_infected_per_day(1,iTime), new_infection, struct_people(1,iPeople)] = ...
                                    tryToInfectNewPerson(struct_people(1,contact_with), contact_with, struct_people(1,iPeople), tot_infected, ...
        ...
        elseif struct_people(1,iPeople).sick_in_isolation == true && ...
            ...
            elseif struct_people(1,iPeople).hospitalized == true
            ...
            elseif struct_people(1,iPeople).fatal_sickness == true
    ...
    for iPeople = 1:num_popul
        ...
        if struct_people(1,iPeople).sick == true || struct_people(1,iPeople).infective == true
